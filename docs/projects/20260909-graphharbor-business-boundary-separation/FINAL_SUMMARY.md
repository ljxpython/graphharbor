...
> 2026-09-25 状态更正：下文为历史阶段总结，其“移除所有业务耦合 / 两个项目已解耦”结论已被当前源码核对取代。生产 worker、固定身份/隔离及 workspace 打包仍有残留，详见 [后续治理计划](../20260925-runtime-business-boundary-decoupling/README.md)。请勿据此认定当前 Final done。
