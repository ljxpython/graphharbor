...
The system SHALL provide an idempotent migration command/job separate from normal server startup and SHALL preserve a documented forward-compatible rollback path.
